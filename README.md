# Учебный проект по итогам курса Otus Data Engineer
...
Устанавливаем и запускаем docker на всех серверах (Ubuntu 20.04)
...
###
		git clone https://github.com/VeraSobal/DE-project.git
<br>
...
Заходим в UI airflow: localhost:8080, user - airflow, password - airflow
...
`Key: station_list`<br>
`Val: ["BE.NMBS.008811304", "BE.NMBS.008811916", "BE.NMBS.008812005", "BE.NMBS.008813003", "BE.NMBS.008813037", "BE.NMBS.008813045", "BE.NMBS.008814001", "BE.NMBS.008815040", "BE.NMBS.008819406"]`<br>
...
Заходим внутрь контейнера и устанавливаем trino
###
...
Заходим в Superset UI: localhost:8080, user - admin, password - admin
